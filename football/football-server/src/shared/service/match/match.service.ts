...
export class MatchService implements MatchServiceInterface {
    ...
    public async insert(data: MatchInsert): Promise<Match> {
        ...
        await this.updatePlayerPoints(data);
    ...
    /**
     * Update player points when updating or inserting a match
     * @param data match update data
     */
    private async updatePlayerPoints(data: MatchUpdate): Promise<void> {
        try {
            let red_striker: any;
